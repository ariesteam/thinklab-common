			...
			for (int i = 0; i < files.length; i++) {
				...
				if (files[i].endsWith(".class")) {
					...
					try {
						...
						Configuration.log.warn("task class " + pckgname + "." + classname + " could not be created: " + e.getMessage());
					}
				} else {
			...
			for (int i = 0; i < files.length; i++) {
				...
				if (files[i].endsWith(".class")) {
					...
					try {
						...
						Configuration.log.warn("task class " + packageName + "." + classname + " could not be created: " + e.getMessage());
					}
				} else {
